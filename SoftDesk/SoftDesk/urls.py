...
urlpatterns = [
    ...
    path('projects/<id>', ProjectsAPIView.as_view(), name='projects'),
    path('projects/<id>/users/', ContributorsAPIView.as_view(), name='contributors'),
    ...
    path('projects/<project_id>/issues/<issue_id>/comments/<id>', CommentsAPIView.as_view(), name='comments'),
]
